...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 3216379555890553931),
      name: 'Batch',
      lastPropertyId: const IdUid(2, 194153170445377288),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 5572229552181391158),
            name: 'batchId',
            type: 6,
            flags: 129),
        ModelProperty(
            id: const IdUid(2, 194153170445377288),
            name: 'batchName',
            type: 9,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 4181199598751354680),
      name: 'Student',
      lastPropertyId: const IdUid(6, 3985118527503688748),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 2791953466898595884),
            name: 'studentId',
            type: 6,
            flags: 129),
        ModelProperty(
            id: const IdUid(2, 5046867826470555078),
            name: 'fname',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 9151700922502120302),
            name: 'lname',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 4225949155897323787),
            name: 'username',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 2313420607639652636),
            name: 'password',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(6, 3985118527503688748),
            name: 'batchId',
            type: 11,
            flags: 520,
            indexId: const IdUid(1, 4366258444657149866),
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(2, 4181199598751354680),
      lastIndexId: const IdUid(1, 4366258444657149866),
  ...
  final bindings = <Type, EntityDefinition>{
    ...
    Student: EntityDefinition<Student>(
        ...
        getId: (Student object) => object.studentId,
        ...
        objectToFB: (Student object, fb.Builder fbb) {
          ...
          fbb.startTable(7);
          fbb.addInt64(0, object.studentId);
